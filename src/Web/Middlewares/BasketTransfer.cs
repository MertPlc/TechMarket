...
namespace Web.Middlewares
{
    public class BasketTransfer
    {
        ...
        {
            // eğer kullanıcı giriş yapmışsa ve hala anonim sepeti duruyorsa 
            // anonim sepetteki her şeyi kullanıcı sepetine taşı (yoksa oluştur)
            // anonim sepeti sil sonra cookie sil
